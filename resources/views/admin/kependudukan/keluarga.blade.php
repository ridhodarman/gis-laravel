...
<div class="tab-pane fade show active" id="kk" role="tabpanel" aria-labelledby="kk">
                ...
                <form action="/keluarga" method="POST">
                    ...
                    <div class="modal-body" style="font-size: 110%">
                        ...
                        <div class="form-group">
                            Family Card Number: <input class="form-control" type="text" name="family_card_number" required>
                        </div>
                        <div class="form-group">
                            Category:
                            <select class="form-control" name="category" style="height: 43px">
                                <option></option>
                        ...
                        <div class="form-group" id="tinggal">
                            Residence Status:
                            <select class="form-control" name="residence_status" style="height: 43px">
                                <option></option>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info btn-xs" data-toggle="modal"
                            onclick="edit(`{{$row->id}}`, `{{$row->family_card_number}}`)"><i class="fa fa-edit"></i> Edit</button>
                        <button class="btn btn-danger btn-xs" title="Hapus"
                            onclick="hapus(`{{$row->id}}`, `{{$row->family_card_number}}`, `{{$row->jumlah}}`)"><i class="fa fa-trash"></i>
                            Delete</button>
                    </td>
                </tr>
                @endforeach
    ...
    @php $row->family_card_number = str_replace("`", "'", session('nama_edit')) @endphp
    <script>
        $(document).ready(function () {
