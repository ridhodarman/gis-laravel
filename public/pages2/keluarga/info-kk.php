                            ...
                            <div class="col-lg-6 mt-6">
                                <div class="card"><div class="card-body">
                                    ...
                                    <table class="table table-hover" style="width: 90%">
                                        <?php
                                            $id = $_GET['id'];
                                             $querysearch = "SELECT F.family_card_number, F.house_building_id, F.category, F.residence_status, H.address,
                                            ...
                                            while ($row = pg_fetch_array($hasil)) {
                                                ...
                                                $r=$row['residence_status'];
                                                $tinggal = $row['category'];
                                                    if ($row['residence_status']!=null) {
                                                        if ($tinggal==0) {
                                                            $tinggal="Contract";
                                                        }
                                                        else {
            ...
            <form action="act/edit-kk.php" method="post" style="width: 115%; background-color: white; border-radius: 1%">
                ...
                <div class="modal-body"">
                    ...
                    <div class="form-group" id="tinggal">
                       Residence Status: 
                        <select class="form-control" name="tinggal" style="height: 43px">
                            <option></option>
