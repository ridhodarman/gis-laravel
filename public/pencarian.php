                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8 col-sm-4 clearfix">
                            <ul class="notification-area pull-right" style="padding-right: 32%">
                                ...
                                <li name="akses-admin"><button class="btn btn-outline btn-primary" onclick="dashboard()"><i class="ti-direction-alt"></i> Back To Dashboard</button></li>
            ...
            <div class="main-content-inner">
                <?php if (is_null(($_GET['id']))) { ?>
                    <div class="card"><div class="card-body"><div class="media mb-5"><div class="media-body">
                        <center><h5><i class="fab fa-searchengin"></i> Search Request</h5></center><br/>
                        <div class="alert alert-warning" role="alert">
                            <strong> Enter the applicant's data first! </strong>
                        </div>
                        <form method="post" action="act/prosescari.php">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    Name:
                                    <input type="text" class="form-control" name="nama" placeholder="enter applicant name...">
                                </div>
                                <div class="form-group col-sm-6">
                                    National Identity Number:
                                    <input type="text" class="form-control" name="nik" placeholder="enter national identity number of applicant...">
                                </div>
                                <div class="form-group col-sm-6">
                                    Job:
                                ...
                                <div class="form-group col-sm-6">
                                    Phone Number:
                                    <input type="text" class="form-control" name="nohp" placeholder="enter phone number of applicant...">
                                </div>
                                <div class="form-group col-sm-6">
                                    Address:
                                ...
                                <div class="form-group col-sm-6">
                                    Necessary:
                                    <textarea class="form-control" name="kebutuhan"></textarea>
                                </div>
                            </div>
                                <center>
                                    <div class="panel panel-default" style="width: 90%;">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    <select class="form-control" name="cari" required style="height: 43px">
                                                        <option></option>
                                                        <option value="Search house by National ID Number of Householder">Search house by National ID Number of Householder</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <input type="text" class="form-control" name="value" placeholder="search value...">
                                                </div>
                                            </div>
                                        </div>          
                                    </div>
                                    ...
                                    &nbsp;
                                    <button type="submit" class="btn btn-success"><i class="fas fa-paper-plane"></i> Process</button>
                                </center>
                        </form>
                        <?php
