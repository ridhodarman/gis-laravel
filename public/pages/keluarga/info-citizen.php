                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-hover" style="width: 90%">
                            <?php
                                $id = $_GET['id'];
                                 $querysearch = "SELECT C.national_identity_number, C.name, C.birth_date, E.educational_level,
                                    J.job_name, C.income, D.datuk_name, T.name_of_tribe, C.family_card_number, C.status_in_family, 
                                    C.education_id, C.datuk_id, C.job_id
                                    FROM citizen AS C
